package com.GL.GradedAssignment2.Part2.MergeSortImplementation1;

import java.util.Scanner;

//Current Stock prices in descending order
public class MergeSortImplementation1 {
	Scanner sc = new Scanner(System.in);

	public void printDescendingCSP(double[] csp) {
		System.out.println("Stock prices in descending order are:");
		for (int i = csp.length - 1; i >= 0; i--) {
